...
const myFavoritePets = new Array();
...
const myFavoritePetsReally = ["dog","cat","kangaroo","whale"];

//you can use Array constructor
const myFavoriteCars = new Array("Ford","BMW","Tesla","Matchbox");

// But it can be a bad idea - imagine my array contains numbers
// Seems good, no?
const myFavoritePlayers = new Array(12,87,11,75);
...
const myOtherFavoritePlayers = new Array(34);
console.log("myOtherFavoritePlayers[0]: "+myOtherFavoritePlayers[0]);

// We can get the length of an array
const myFavoriteFoods = ["Quinoa Salad","Steamed Vegetables","Ribeye Steak"];
...
const myMixedArray = [4, "Bob", true, ["another","array","inside"]];
console.log("myMixedArray[1]: "+ myMixedArray[1]);
console.log("myMixedArray[3][2]: " + myMixedArray[3][2]);

const my2DArray = [[0,0,0],[0,1,2],[0,2,4],[0,3,6]];
