...
const regex = /^[a-z]{3}\d{3}/i;  //start of string, 3 letters, 3 digits, not case-sensitive
const r2 =  /[a-z,A-Z]{3}\d{3}/; // 3 letters, 3 digits
...
const r3 = /\w{3}\d{3}/;  //3 word characters,3 digits (but also would match '123456')

const r4 = /\D{3}\d{3}/;  //3 non-digits, 3 digits (but also would match '$#@234')
